...
('faq-account','A minha conta é a mesma do Nexauren?','Sim. O Builder usa a autenticação da conta Nexauren e não cria uma segunda conta de utilizador.','account',10,1,strftime('%s','now'),strftime('%s','now')),
